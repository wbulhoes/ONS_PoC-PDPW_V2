...
import styles from './IR3.module.css';
import { IR3FormData, IR3TableRow } from '../../../types/regulatoryInputs';

/**
 * Componente para Coleta de IR3 - Dia -2
 * Registra valores regulatórios de dois dias atrás
 * 24 intervalos horários para histórico operacional
 */
const IR3: React.FC = () => {
  const [formData, setFormData] = useState<IR3FormData>({
    dataPDP: '',
    empresa: '',
    usina: ''
  });

  const [tableData, setTableData] = useState<IR3TableRow[]>([]);
  ...
  const handleSave = () => {
    ...
    console.log('Salvando IR3 - Dia -2:', { formData, tableData });
    alert('Dados do Dia -2 salvos com sucesso!');
  };
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div className={styles.pageTitle}>
          <h2 className={styles.title}>Dia -2</h2>
        </div>
      </div>
