...
import OutOfMeritCRE from '../../../src/pages/Collection/Other/OutOfMeritCRE';

describe('OutOfMeritCRE Component', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe('Seleção', () => {
    it('deve exibir textarea', async () => {
      ...
      await waitFor(() => {
        const textarea = screen.getByPlaceholderText(/Digite valores CRE/i);
  ...
  describe('Salvamento', () => {
    it('deve salvar', async () => {
      ...
      await waitFor(() => {
        expect(alertSpy).toHaveBeenCalledWith('CRE Fora de Mérito salvo com sucesso!');
      });
