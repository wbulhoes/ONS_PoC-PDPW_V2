...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intir2, d.valir2" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_IR2 d, usina u " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intir2"
            Conn.Open(strBase)
