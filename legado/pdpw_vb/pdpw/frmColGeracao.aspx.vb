...
#End Region
    ...
    ''' <summary>
    ''' Obtem a consulta de usina
    ''' </summary>
    ''' <returns></returns>
    Private Function ObterSqlUsinas() As String

        Dim sql As String = ""

        sql = "Select distinct d.codusina, " &
                              "       u.ordem " &
                              "From despa d, " &
                              "     usina u " &
                              " inner join tpusina " &
                              " On u.tpusina_id = tpusina.tpusina_id " &
                              "    And tpusina.id_tpgeracao in (" & ObtemTipoUsinaParaSql() & ") " &
    ...
    Private Function ObtemTipoUsinaParaSql() As String
        Dim tipoUsina As String = "1,2,3,4,5"

        If cboTipoUsina.SelectedItem.Value = "Hidro" Then
            tipoUsina = "1"
        ElseIf cboTipoUsina.SelectedItem.Value = "Termo" Then
            tipoUsina = "2,3,4,5"
        End If
    ...
    Private Sub cboEmpresa_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboEmpresa.SelectedIndexChanged
        ...
        Try
            ...
            Cmd.CommandText = ObterSqlUsinas()
            ...
            If Not ValidaLimiteEntradaDados(cboEmpresa.SelectedItem.Value, cboData.SelectedItem.Value, lRetorno, "GER") Then
                btnSalvar.Visible = False
                cboUsina.Enabled = False
                cboTipoUsina.Enabled = False
                If lRetorno = 1 Then
    ...
    Private Sub cboUsina_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboUsina.SelectedIndexChanged
        ...
        Try
            If cboUsina.SelectedItem.Text = "Todas as Usinas" Then
                Cmd.CommandText = "Select d.valdespatran, " &
                                "       d.intdespa, " &
                                "       d.codusina, " &
                                "       u.ordem " &
                                "From despa d, " &
            ...
            Do While rsUsina.Read
                If blnPassou Then
                    If rsUsina("intdespa") <> intInstante Then
                        intInstante = rsUsina("intdespa")
                        objTextArea.Value = objTextArea.Value & Chr(13)
                    Else
                        objTextArea.Value = objTextArea.Value & Chr(9)
                    End If
                End If
                If Not IsDBNull(rsUsina.Item("valdespatran")) Then
                    objTextArea.Value = objTextArea.Value & rsUsina.Item("valdespatran")
                Else
    ...
    Private Sub PreencheTable()
        ...
        Try
            ...
            Do While rsUsina.Read
                ...
                objCel.Width = objTamanho.Pixel(64)
                If Not IsDBNull(rsUsina.Item("valdespatran")) Then
                    objCel.Text = rsUsina.Item("valdespatran")
                    dblMedia = dblMedia + rsUsina.Item("valdespatran")
                Else
                    objCel.Text = 0
                End If
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSalvar.Click
        ...
        If EstaAutorizado Then
            ...
            Try
                ...
                GravaEventoPDP("7", Format(Session("datEscolhida"), "yyyyMMdd"), cboEmpresa.SelectedItem.Text, datAtual, "PDPColGera", UsuarID)
    ...
    Private Sub cboTipoUsina_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboTipoUsina.SelectedIndexChanged
        If cboEmpresa.SelectedIndex > 0 Then
            Call cboEmpresa_SelectedIndexChanged(sender, e)
        End If
    End Sub
End Class
