Partial Class frmCnsInflexibilidade
...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intflexi, d.valflexi" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intflexi"
            Conn.Open()
