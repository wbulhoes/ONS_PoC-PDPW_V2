<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColManutencaoUG.aspx.vb" Inherits="pdpw.frmColManutencaoUG" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 831px; height: 482px" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td valign="top">
                    <div align="center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 762px; height: 8px">
                                                        <div align="left">
                                                            <img style="width: 280px; height: 23px" height="23" src="../pdpw/images/tit_ColManutencaoUG.gif"
                                                                width="280">
                                                        </div>
                                                    </td>
                                                </tr>
                        ...
                        <br>
                        <form id="frmColManutencaoUG" name="frmColManutencaoUG" runat="server">
                            <table class="modulo" style="width: 726px; height: 321px" cellspacing="0" cellpadding="0"
                                border="0">
                                <tr>
                                    <td style="width: 460px; height: 31px" colspan="2">&nbsp;&nbsp; Código:
											...
											Código Externo:&nbsp;&nbsp;<asp:TextBox ID="txtCodExterno" runat="server" Enabled="False" Height="20px" Width="69px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr align="left">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="height: 70px">
                                        <table class="modulo" style="width: 156px; height: 77px">
                                            <tr>
                                                <td>&nbsp;&nbsp; Nível<br>
                                                    <asp:RadioButtonList ID="optNivel" Height="44px" Width="148px" runat="server" Font-Size="XX-Small" Font-Bold="True">
                                                        <asp:ListItem Value="MP" Selected="True">P - Programado</asp:ListItem>
                                                        <asp:ListItem Value="ME">E - Emerg&#234;ncia</asp:ListItem>
                                                        <asp:ListItem Value="MU">U - Urg&#234;ncia</asp:ListItem>
                                ...
                                <tr>
                                    <td style="width: 569px; height: 31px" colspan="2">
                                        <table class="modulo" style="width: 622px; height: 38px" border="0">
                                            <tr>
                                                <td style="width: 332px; height: 1px">Continuidade</td>
                                                <td style="width: 118px; height: 1px" colspan="2">Horário de Volta</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 332px; height: 3px">
                                                    <asp:DropDownList ID="cboContinuidade" runat="server" Height="20px" Width="249px" AutoPostBack="True">
                                                        <asp:ListItem Value="D">Di&#225;ria</asp:ListItem>
                                                        <asp:ListItem Value="C">Cont&#237;nua</asp:ListItem>
                                                        <asp:ListItem Value="V">Descont&#237;nua (possui intervalo de volta)</asp:ListItem>
                                                    </asp:DropDownList></td>
                                                <td style="width: 118px; height: 3px">De:&nbsp;<asp:DropDownList ID="cboVoltaInicial" runat="server" Enabled="False" Height="20px" Width="64px">
                                                    <asp:ListItem></asp:ListItem>
                                                    <asp:ListItem Value="00:30">00:30</asp:ListItem>
                                                    <asp:ListItem Value="01:00">01:00</asp:ListItem>
                                                    <asp:ListItem Value="01:30">01:30</asp:ListItem>
                                                ...
                                                <td style="height: 3px">Até:&nbsp;<asp:DropDownList ID="cboVoltaFinal" runat="server" Enabled="False" Height="20px" Width="63px">
                                                    <asp:ListItem></asp:ListItem>
                                                    <asp:ListItem Value="00:30">00:30</asp:ListItem>
                                                    <asp:ListItem Value="01:00">01:00</asp:ListItem>
                                                    <asp:ListItem Value="01:30">01:30</asp:ListItem>
                                ...
                                <tr>
                                    <td style="height: 20px" align="center" colspan="2" height="20">
                                        <table width="71">
                                            <tr>
                                                <td style="width: 71px">
                                                    <asp:ImageButton ID="btnSalvar" Height="25px" Width="71px" runat="server" ImageUrl="../pdpw/images/bt_salvar.gif"></asp:ImageButton></td>
                                                <td style="width: 71px">
                                                    <asp:ImageButton ID="btnVoltar" Height="25px" Width="71px" runat="server" ImageUrl="../pdpw/images/bt_voltar.gif"></asp:ImageButton></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
