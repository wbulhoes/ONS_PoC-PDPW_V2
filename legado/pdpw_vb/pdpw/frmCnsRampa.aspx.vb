...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents frmCnsDespInflex As System.Web.UI.HtmlControls.HtmlForm
...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT r.codusina, r.intrmp, r.valrmp" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              ...
                              "ORDER BY u.ordem, r.codusina, r.intrmp"
            Conn.ConnectionString = ConfigurationManager.AppSettings.Get("pdpSQL").ToString()
            Conn.Open()
