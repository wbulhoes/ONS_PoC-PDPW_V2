<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="OldfrmRestricaoUS.aspx.vb" Inherits="pdpw.frmRestricaoUS" %>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="height: 8px">
                                                        <div align="left">
                                                            <img height="23" src="../pdpw/images/tit_ColRestricaoUS.gif" width="192" style="width: 192px; height: 23px"></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
