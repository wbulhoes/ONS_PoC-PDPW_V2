<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColEletrica.aspx.vb" Inherits="pdpw.frmColEletrica" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColEletrica.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColEletrica.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
                ...
                <tr>
                    ...
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="../pdpw/images/tit_RazaoEletrica.gif" width="144" style="width: 144px; height: 23px"></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <form id="frmColEletrica" name="frmColEletrica" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 750px" valign="top">
                                <asp:Table ID="tblEletrica" runat="server" Width="51px" BorderStyle="Ridge" BorderWidth="1px"
