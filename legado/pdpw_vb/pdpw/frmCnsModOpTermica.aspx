<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="frmCnsModOpTermica.aspx.vb" Inherits="pdpw.frmCnsModOpTermica" %>
				...
				<tr>
					...
					<td vAlign="top">
						<div align="center">
										...
										<td style="HEIGHT: 10px" height="10">
											<table cellSpacing="0" cellPadding="0" width="765" background="../pdpw/images/back_titulo.gif"
												...
												<tbody>
													<tr>
														<td style="HEIGHT: 8px">
															<div align="left"><IMG height="23" src="../pdpw/images/tit_ModOpTermica.gif" width="272" style="WIDTH: 272px; HEIGHT: 23px"></div>
														</td>
													</tr>
												</tbody>
											</table>
							...
							<br>
							<form id="frmCnsModOpTermica" name="frmCnsModOpTermica" runat="server">
