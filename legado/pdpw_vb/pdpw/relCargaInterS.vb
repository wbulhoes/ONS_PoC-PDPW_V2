...
Public Class relCargaInterS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relCargaInterS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelCargaInterS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relCargaInterS = New relCargaInterS()
        rpt.Site = Me.Site
        Return rpt
    End Function
