<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColCreForaMerito.aspx.vb" Inherits="pdpw.frmColCreForaMerito" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColCreForaMerito.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColCreForaMerito.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                            ...
                            <td style="height: 10px" height="10">
                                <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                    ...
                                    <tr>
                                        <td style="height: 8px">
                                            <div align="left">
                                                <img style="width: 208px; height: 23px" height="23" src="../pdpw/images/tit_CreForaMerito.gif"
                                                    width="208">
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <br>
                    <form id="frmColCreForaMerito" name="frmColCreForaMerito" runat="server">
                        <table style="width: 1061px; height: 88px" height="88" cellspacing="0" cellpadding="0"
                            width="1061" border="0">
                            <tr height="30">
                                <td style="width: 170px; height: 29px" align="right"><b>Data PDP:</b></td>
                                <td style="width: 257px; height: 29px">&nbsp;<asp:DropDownList ID="cboData" runat="server" AutoPostBack="True" Width="98px"></asp:DropDownList></td>
                            </tr>
                            <tr height="30">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblCFM" runat="server" Width="51px" BorderStyle="Ridge" BorderWidth="1px" CellPadding="2"
                                            CellSpacing="0" GridLines="Both" Height="26px" Font-Size="Smaller">
                                        </asp:Table>
