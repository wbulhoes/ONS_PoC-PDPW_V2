<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="OldfrmParadaUG.aspx.vb" Inherits="pdpw.frmParadaUG" %>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="height: 8px">
                                                        <div align="left">
                                                            <img height="23" src="images/tit_ColParadaUG.gif" width="416" style="width: 416px; height: 23px"></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
