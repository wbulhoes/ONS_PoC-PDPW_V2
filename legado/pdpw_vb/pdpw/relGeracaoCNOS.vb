...
Public Class relGeracaoCNOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relGeracaoCNOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelGeracaoCNOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relGeracaoCNOS = New relGeracaoCNOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
