...
Public Class relBalancoCNOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relBalancoCNOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelBalancoCNOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relBalancoCNOS = New relBalancoCNOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
