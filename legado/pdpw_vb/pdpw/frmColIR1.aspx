<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColIR1.aspx.vb" Inherits="pdpw.frmColIR1" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColIR1.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColIR1.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                    ...
                    <br>
                    <form id="frmColIR1" name="frmColIR1" runat="server">
                        <table style="width: 1078px; height: 64px" height="64" cellspacing="0" cellpadding="0"
                            ...
                            <tr height="30">
                                <td style="width: 170px; height: 24px" align="right"><b>Valor:</b></td>
                                <td style="width: 881px; height: 24px">&nbsp;<input type="text" id="vlNivPartida" runat="server" />&nbsp;&nbsp;&nbsp;
