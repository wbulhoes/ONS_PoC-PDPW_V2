<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="frmCnsMotivoInfl.aspx.vb" Inherits="pdpw.frmCnsMotivoInfl"%>
				...
				<tr>
					...
					<td vAlign="top">
						<div align="center">
										...
										<td style="HEIGHT: 10px" height="10">
											<table cellSpacing="0" cellPadding="0" width="765" background="../pdpw/images/back_titulo.gif"
												...
												<tbody>
													<tr>
														<td style="HEIGHT: 8px">
															<div align="left"><IMG style="WIDTH: 304px; HEIGHT: 23px" height="23" src="../pdpw/images/tit_CnsMotivoInfl.gif"
																	width="304"></div>
														</td>
													</tr>
												</tbody>
							...
							<form id="frmCnsMotivoInfl" name="frmCnsMotivoInfl" runat="server">
								<DIV class="modulo" id="divGrid" style="DISPLAY: inline; WIDTH: 702px; HEIGHT: 184px"
									ms_positioning="FlowLayout"><asp:datagrid id="dtgMotivo" runat="server" Width="700px" AllowPaging="True" AutoGenerateColumns="False"
										...
										<Columns>
											<asp:BoundColumn DataField="codmotivo" ReadOnly="True" HeaderText="C&#243;digo">
												<HeaderStyle Width="30px"></HeaderStyle>
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="motivo" ReadOnly="True" HeaderText="Descri&#231;&#227;o do Motivo">
