<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="frmCnsMotivo.aspx.vb" Inherits="pdpw.frmCnsMotivo"%>
										...
										<td style="HEIGHT: 10px" height="10">
											<table cellSpacing="0" cellPadding="0" width="765" background="../pdpw/images/back_titulo.gif"
												...
												<tbody>
													<tr>
														<td style="HEIGHT: 8px">
															<div align="left"><IMG style="WIDTH: 264px; HEIGHT: 23px" height="23" src="../pdpw/images/tit_CnsMotivo.gif"
																	width="264"></div>
														</td>
													</tr>
												</tbody>
