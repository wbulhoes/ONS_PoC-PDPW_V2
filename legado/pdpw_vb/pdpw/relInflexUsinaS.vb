...
Public Class relInflexUsinaS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relInflexUsinaS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelInflexUsinaS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relInflexUsinaS = New relInflexUsinaS()
        rpt.Site = Me.Site
        Return rpt
    End Function
