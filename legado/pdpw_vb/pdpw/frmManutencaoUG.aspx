<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmManutencaoUG.aspx.vb" Inherits="pdpw.frmManutencaoUG" %>
            ...
            <tr>
                ...
                <td valign="top">
                    <div align="center">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="height: 8px">
                                                        <div align="left">
                                                            <img height="23" src="../pdpw/images/tit_ColManutencaoUG.gif" width="288" style="width: 288px; height: 23px"></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <br>
                        <form id="frmManutencaoUG" name="frmManutencaoUG" runat="server">
                            <table style="width: 505px; height: 256px" height="256" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 345px; height: 30px">&nbsp;<asp:DropDownList ID="cboData" runat="server" Width="96px" AutoPostBack="True"></asp:DropDownList></td>
                                </tr>
                                <tr height="42">
                                ...
                                <tr valign="top" align="center">
                                    <td style="width: 539px; height: 46px" colspan="2">
                                        <br>
