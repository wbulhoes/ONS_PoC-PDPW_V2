<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColDespInflex.aspx.vb" Inherits="pdpw.frmColDespInflex" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColDespInflex.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColDespInflex.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
                ...
                <tr>
                    ...
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="../pdpw/images/tit_DespInflex.gif" width="296" style="width: 296px; height: 23px"></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <form id="frmColDespInflex" name="frmColDespInflex" runat="server">
                                ...
                                <table style="width: 1078px; height: 124px" height="124" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="display: inline; z-index: 1; left: 20px; width: 131px; position: absolute; top: 270px; height: 45px"
                                                ms_positioning="FlowLayout">
                                                <asp:Table ID="tblmotivoinfl" runat="server" Width="47px" Font-Size="Smaller" Height="26px"
