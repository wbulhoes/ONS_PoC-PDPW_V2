Partial Class frmCnsGerForaMerito
...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents frmCreForaMerito As System.Web.UI.HtmlControls.HtmlForm
...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT r.codusina, r.intgfm, r.valgfm" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_gfm r, usina u " &
                              "WHERE u.codempre = '" & cboEmpresa.SelectedItem.Value & "' " &
                              "AND u.codusina = r.codusina " &
                              "AND r.datpdp = '" & cboDataInicial.SelectedItem.Value & "' " &
                              "AND u.flg_recebepdpage = 'S' " &
                              "ORDER BY u.ordem, r.codusina, r.intgfm"
            Conn.Open(strBase)
