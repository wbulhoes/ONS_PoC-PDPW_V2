<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColGerForaMerito.aspx.vb" Inherits="pdpw.frmColGerForaMerito" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColGerForaMerito.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColGerForaMerito.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                            ...
                            <td style="height: 10px" height="10">
                                <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                    ...
                                    <tr>
                                        <td style="height: 8px">
                                            <div align="left">
                                                <img style="width: 216px; height: 23px" height="23" src="../pdpw/images/tit_GerForaMerito.gif"
                                                    width="216">
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <br>
                    <form id="frmColGerForaMerito" name="frmColGerForaMerito" runat="server">
                        <table style="width: 1078px; height: 88px" height="88" cellspacing="0" cellpadding="0"
                            width="1078" border="0">
                            <tr height="30">
                            ...
                            <tr height="30">
                                <td style="width: 170px; height: 26px" align="right"><b>Empresa:</b></td>
                                <td style="width: 750px; height: 26px">&nbsp;<asp:DropDownList ID="cboEmpresa" runat="server" AutoPostBack="True" Width="219px"></asp:DropDownList></td>
                            </tr>
                            <tr height="30">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblGFM" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
