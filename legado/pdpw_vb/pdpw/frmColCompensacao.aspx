<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColCompensacao.aspx.vb" Inherits="pdpw.frmColCompensacao" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColCompensacao.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColCompensacao.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                            ...
                            <td style="height: 10px" height="10">
                                <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                    ...
                                    <tr>
                                        <td style="height: 8px">
                                            <div align="left">
                                                <img style="width: 264px; height: 23px" height="23" src="../pdpw/images/tit_ColCLF.gif"
                                                    width="264">
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <form id="frmColCompensacao" name="frmColCompensacao" runat="server">
                        ...
                        <table style="width: 1078px; height: 88px" height="88" cellspacing="0" cellpadding="0"
                            width="1078" border="0">
                            <tr height="30">
                                <td style="width: 170px; height: 23px" align="right"><b>Data PDP:</b></td>
                                <td style="width: 257px; height: 23px">&nbsp;<asp:DropDownList ID="cboData" runat="server" AutoPostBack="True" Width="98px"></asp:DropDownList></td>
                            </tr>
                            <tr height="30">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblCLF" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
