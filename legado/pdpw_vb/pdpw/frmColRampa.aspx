<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColRampa.aspx.vb" Inherits="pdpw.frmColRampa" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColRampa.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColRampa.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                            ...
                            <td style="height: 10px" height="10">
                                <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                    ...
                                    <tr>
                                        <td style="height: 8px">
                                            <div align="left">
                                                <img style="width: 184px; height: 23px" height="23" src="../pdpw/images/tit_rampa.gif"
                                                    width="184">
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <br>
                    <form id="frmColRampa" name="frmColRampa" runat="server">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblRMP" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
