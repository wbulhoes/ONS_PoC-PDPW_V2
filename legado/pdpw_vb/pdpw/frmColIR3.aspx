<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColIR3.aspx.vb" Inherits="pdpw.frmColIR3" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColIR3.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColIR3.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                    ...
                    <br>
                    <form id="frmColIR3" name="frmColIR3" runat="server">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblIR3" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
