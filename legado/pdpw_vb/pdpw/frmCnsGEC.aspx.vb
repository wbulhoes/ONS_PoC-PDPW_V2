...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intgec, d.valgec" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_GEC d, usina u " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intgec"
            Conn.ConnectionString = ConfigurationManager.AppSettings.Get("pdpSQL").ToString()
            Conn.Open()
