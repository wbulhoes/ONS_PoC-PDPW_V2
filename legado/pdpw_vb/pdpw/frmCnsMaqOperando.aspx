<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="frmCnsMaqOperando.aspx.vb" Inherits="pdpw.frmCnsMaqOperando"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			<table style="WIDTH: 784px; HEIGHT: 264px" height="264" cellSpacing="0" cellPadding="0"
			width="784" border="0">
			<tbody>
				<tr>
					<td style="WIDTH: 19px; HEIGHT: 247px" vAlign="top" width="19"><BR>
					</td>
					<td vAlign="top" style="WIDTH: 767px; HEIGHT: 247px">
						<div align="center">
										...
										<td style="HEIGHT: 10px" height="10">
											<table cellSpacing="0" cellPadding="0" width="765" background="../pdpw/images/back_titulo.gif"
												...
												<tbody>
													<tr>
														<td style="HEIGHT: 8px">
															<div align="left"><IMG height="23" src="../pdpw/images/tit_ColMaqOperando.gif" width="344" style="WIDTH: 344px; HEIGHT: 23px"></div>
														</td>
													</tr>
												</tbody>
											</table>
							...
							<br>
							<form id="frmCnsMaqOperando" name="frmCnsMaqOperando" runat="server">
								<div id="divtabela" style="LEFT: 80px; WIDTH: 617px; POSITION: absolute; TOP: 120px; HEIGHT: 144px">
									<table class="modulo" style="WIDTH: 616px; HEIGHT: 106px" cellSpacing="0" cellPadding="0"
										border="0">
										<tr vAlign="top">
										...
										<tr>
											...
											<td style="WIDTH: 306px">
												<table class="formulario_texto" style="WIDTH: 311px; HEIGHT: 59px" cellSpacing="0" cellPadding="0"
													...
													<tr>
														...
														<td style="WIDTH: 209px; HEIGHT: 27px"><asp:dropdownlist id="cboDataInicial" runat="server" Width="90px"></asp:dropdownlist>&nbsp;</td>
													</tr>
													<tr>
														<td style="WIDTH: 93px; HEIGHT: 27px" align="right">Empresa&nbsp;</td>
														<td style="WIDTH: 209px; HEIGHT: 27px"><asp:dropdownlist id="cboEmpresa" runat="server" Width="199px"></asp:dropdownlist></td>
													</tr>
												</table>
												<P>&nbsp;</P>
											</td>
											...
											<td align="center" style="WIDTH: 88px"><IMG id="imgPlanilha" onmouseover="this.style.cursor='hand'" onclick="javascript:botao();"
		...
		<DIV style="DISPLAY: inline; LEFT: 68px; WIDTH: 640px; POSITION: absolute; TOP: 260px; HEIGHT: 43px"
			ms_positioning="FlowLayout" align="left">
