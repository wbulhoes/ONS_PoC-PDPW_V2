<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="frmCnsCompensacao.aspx.vb" Inherits="pdpw.frmCnsCompensacao"%>
			...
			<tr>
				...
				<td style="HEIGHT: 248px" vAlign="top">
					<div align="center">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td style="HEIGHT: 17px" height="17">
									<table style="WIDTH: 772px; HEIGHT: 25px" cellSpacing="0" cellPadding="0" width="772" background="images/back_tit_sistema.gif"
										border="0">
										<tr>
							...
							<tr>
								<td style="HEIGHT: 10px" height="10">
									<table style="WIDTH: 771px; HEIGHT: 27px" cellSpacing="0" cellPadding="0" width="771" background="images/back_titulo.gif"
										...
										<tr>
											<td style="HEIGHT: 8px">
												<div align="left"><IMG style="WIDTH: 224px; HEIGHT: 23px" height="23" src="images/tit_ColCLF.gif" width="224">
												</div>
											</td>
										</tr>
									</table>
						...
						<form id="frmCnsCompensacao" name="frmCnsCompensacao" runat="server">
						...
						<BR>
							<div id="divtabela" style="LEFT: 80px; WIDTH: 602px; POSITION: absolute; TOP: 120px; HEIGHT: 131px">
								<table class="modulo" style="WIDTH: 609px; HEIGHT: 112px" cellSpacing="0" cellPadding="0"
									border="0">
									<tr vAlign="top">
										<td style="WIDTH: 108px; HEIGHT: 11px"><%if request.querystring("strAcesso") <> "PDOC" then 
																						response.write("Dados:") 
																				end if%></td>
										<td style="WIDTH: 306px; HEIGHT: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Selecionar:</td>
