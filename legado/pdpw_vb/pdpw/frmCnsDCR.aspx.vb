...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intdcr, d.valdcr" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_DCR d, usina u " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intdcr"
            Conn.Open(strBase)
