...
#End Region
        ...
        If Not Page.IsPostBack Then
            ...
            Try
                ...
                Do While rsEmpresa.Read
                    ...
                    ' Alteração: Comparação com Session("strCodEmpre") corrigida
                    If Trim(cboEmpresa.Items(intI).Value) = Trim(CType(Session("strCodEmpre"), String)) Then
                ...
                Do While rsData.Read
                    ...
                    ' Alteração: Comparação com Session("datEscolhida") corrigida
                    If Session("datEscolhida") IsNot Nothing Then
                        Dim datEscolhida As Date = CType(Session("datEscolhida"), Date)
                        If Trim(cboDataInicial.Items(intI).Value) = Format(datEscolhida, "yyyyMMdd") Then
            ...
            Catch ex As Exception
                ...
                End If
                ' Log do erro
                ' logger.Error("Erro ao carregar a página: " & ex.Message, ex)
            Finally
                If Conn.State = ConnectionState.Open Then
                    Conn.Close()
                End If
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intdespa, d.valdespa" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intdespa"
            Conn.Open()
