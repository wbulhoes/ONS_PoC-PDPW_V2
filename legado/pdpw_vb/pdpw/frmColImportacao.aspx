<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColImportacao.aspx.vb" Inherits="pdpw.frmColImportacao" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColImportacao.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColImportacao.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
                ...
                <tr>
                    ...
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="../pdpw/images/tit_ColImportacao.gif" width="120" style="width: 120px; height: 23px"></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <br>
                            <form id="frmColImportacao" name="frmColImportacao" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 750px" valign="top">
                                <asp:Table ID="tblImportacao" runat="server" Width="51px" BorderStyle="Ridge" BorderWidth="1px"
