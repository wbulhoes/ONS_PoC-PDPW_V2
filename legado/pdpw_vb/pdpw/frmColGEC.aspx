<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColGEC.aspx.vb" Inherits="pdpw.frmColGEC" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColGEC.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColGEC.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                    ...
                    <br>
                    <form id="frmColGEC" name="frmColGEC" runat="server">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblGEC" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
