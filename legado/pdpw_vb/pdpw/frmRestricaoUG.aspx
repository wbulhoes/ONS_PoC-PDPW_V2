<%@ Page Language="vb" AutoEventWireup="false" Codebehind="frmRestricaoUG.aspx.vb" Inherits="pdpw.frmRestricaoUG"%>
										...
										<TD style="HEIGHT: 10px" height="10">
											<TABLE cellSpacing="0" cellPadding="0" width="765" background="../pdpw/images/back_titulo.gif"
												...
												<TBODY>
													<TR>
														<TD style="HEIGHT: 8px">
															<DIV align="left"><IMG height="23" src="../pdpw/images/tit_ColRestricaoUG.gif" width="280" style="WIDTH: 280px; HEIGHT: 23px"></DIV>
														</TD>
													</TR>
												</TBODY>
											</TABLE>
								...
								<table style="WIDTH: 505px; HEIGHT: 241px" height="241" cellSpacing="0" cellPadding="0"
									...
									<tr height="42">
										...
										<td style="WIDTH: 345px; HEIGHT: 25px">
											<P>&nbsp;<asp:dropdownlist id="cboEmpresa" runat="server" Width="219px" AutoPostBack="True"></asp:dropdownlist>
											</P>
										</td>
									</tr>
									<tr height="42">
									...
									<tr vAlign="top" align="center">
										<td style="WIDTH: 600px; HEIGHT: 7px" colSpan="2"><br>
									...
									<tr>
										<td style="WIDTH: 560px; HEIGHT: 50px" colSpan="2" align="center">
											<table>
												<tr>
													<td style="WIDTH: 71px"><asp:imagebutton id="btnIncluir" runat="server" Width="71px" ImageUrl="../pdpw/images/bt_incluir.gif"
															Height="25px"></asp:imagebutton></td>
													<td style="WIDTH: 71px"><asp:imagebutton id="btnExcluir" runat="server" Width="71px" ImageUrl="../pdpw/images/bt_excluir.gif"
															Height="25px"></asp:imagebutton></td>
													<td style="WIDTH: 71px"><asp:imagebutton id="btnAlterar" runat="server" Width="71px" ImageUrl="../pdpw/images/bt_alterar.gif"
															Height="25px"></asp:imagebutton></td>
												</tr>
											</table>
										</td>
