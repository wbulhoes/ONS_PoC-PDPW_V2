<%@ Page Language="vb" AutoEventWireup="false" Codebehind="frmColMaqParada.aspx.vb" Inherits="pdpw.frmColMaqParada"%>
											...
											<TD height="2">
												<TABLE cellSpacing="0" cellPadding="0" width="765" background="../pdpw/images/back_titulo.gif"
													...
													<TBODY>
														<TR>
															<TD>
																<DIV align="left"><IMG style="WIDTH: 416px; HEIGHT: 23px" height="23" src="../pdpw/images/tit_ColMaqParada.gif"
																		width="416"></DIV>
															</TD>
														</TR>
													</TBODY>
