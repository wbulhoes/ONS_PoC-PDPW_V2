...
Public Class relUsiPorEmpre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relUsiPorEmpre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelUsiPorEmpre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relUsiPorEmpre = New relUsiPorEmpre()
        rpt.Site = Me.Site
        Return rpt
    End Function
