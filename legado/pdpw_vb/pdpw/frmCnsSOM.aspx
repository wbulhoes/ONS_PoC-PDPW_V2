<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmCnsSOM.aspx.vb" Inherits="pdpw.frmCnsSOM" %>
            ...
            <tr>
                ...
                <td valign="top">
                    <div align="center">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="height: 8px">
                                                        <div align="left">
                                                            <img height="23" src="../pdpw/images/tit_som.gif" width="232" style="width: 232px; height: 23px"></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <br>
                        <form id="frmCnsSom" name="frmCnsSom" runat="server">
