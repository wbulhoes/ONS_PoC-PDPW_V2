<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="OldfrmCnsDCR.aspx.vb" Inherits="pdpw.frmCnsDCR"%>
			...
			<tr>
				...
				<td style="HEIGHT: 248px" vAlign="top">
					<div align="center">
							...
							<tr>
								<td style="HEIGHT: 10px" height="10">
									<table style="WIDTH: 771px; HEIGHT: 27px" cellSpacing="0" cellPadding="0" width="771"
										...
										<tr>
											<td style="HEIGHT: 8px">
												<div align="left"><p class="titulo">Despacho Ciclo Reduzido</p>
												</div>
											</td>
										</tr>
									</table>
						...
						<BR>
						<form id="frmCnsDCR" name="frmCnsDCR" runat="server">
