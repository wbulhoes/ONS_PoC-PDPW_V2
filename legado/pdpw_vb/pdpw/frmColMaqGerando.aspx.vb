...
#End Region
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSalvar.Click
        ...
        objPermissao = New OnsClasses.OnsInterfaceUnica.OnsPermissao("UPD", "PDPColMaqGerand", Session("usuarID"))
        ...
        If objPermissao.EstaAutorizado Then
            ...
            Try
                ...
                GravaEventoPDP("38", Format(Session("datEscolhida"), "yyyyMMdd"), cboEmpresa.SelectedItem.Text, datAtual, "PDPColMaqGerand", Session("usuarID"))
