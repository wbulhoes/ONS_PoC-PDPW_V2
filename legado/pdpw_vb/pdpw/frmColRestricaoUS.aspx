<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColRestricaoUS.aspx.vb" Inherits="pdpw.frmColRestricaoUS" %>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 762px; height: 8px">
                                                        <div align="left">
                                                            <img height="23" src="../pdpw/images/tit_ColRestricaoUS.gif" width="184" style="width: 184px; height: 23px"></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <table class="modulo" style="width: 726px; height: 341px" cellspacing="0" cellpadding="0"
                                ...
                                <tr align="left">
                                    <td style="width: 719px; height: 40px" colspan="3">
                                        <table class="modulo" style="width: 775px; height: 58px">
                                            <tr>
                                                <td style="width: 320px; height: 30px" colspan="3">&nbsp;Usina:&nbsp;<asp:DropDownList ID="cboUsina" runat="server" Width="320px" Height="20px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 491px">Observação
											<asp:TextBox ID="txtObsRestr" runat="server" Width="530px" MaxLength="255" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 719px; height: 14px" colspan="3">
