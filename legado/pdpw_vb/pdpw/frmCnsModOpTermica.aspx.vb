Public Class frmCnsModOpTermica
...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents optDados As System.Web.UI.WebControls.RadioButtonList
    Protected WithEvents cboDataInicial As System.Web.UI.WebControls.DropDownList
    Protected WithEvents cboEmpresa As System.Web.UI.WebControls.DropDownList
    Protected WithEvents btnVisualizar As System.Web.UI.WebControls.ImageButton
    Protected WithEvents lblMensagem As System.Web.UI.WebControls.Label
    Protected WithEvents tblConsulta As System.Web.UI.WebControls.Table
    Protected WithEvents imgPlanilha As System.Web.UI.HtmlControls.HtmlImage
...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina,u.nomusina, d.intmot, d.valmot" & strcampo & " as valor, u.ordem " &
            ...
            Do While rsConsulta.Read
                If strCodUsina <> rsConsulta("codusina") Then
                    ...
                    'Reginaldo
                    objCell.ToolTip = rsConsulta.Item("nomusina") '-- Nome da Usina
