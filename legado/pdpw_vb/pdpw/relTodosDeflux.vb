...
Public Class relTodosDeflux
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relTodosDeflux.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelTodosDeflux
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relTodosDeflux = New relTodosDeflux()
        rpt.Site = Me.Site
        Return rpt
    End Function
