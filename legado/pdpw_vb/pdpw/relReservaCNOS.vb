...
Public Class relReservaCNOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relReservaCNOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelReservaCNOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relReservaCNOS = New relReservaCNOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
