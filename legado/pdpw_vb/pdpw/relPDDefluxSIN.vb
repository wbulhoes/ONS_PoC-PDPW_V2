...
Public Class relPDDefluxSIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relPDDefluxSIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelPDDefluxSIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relPDDefluxSIN = New relPDDefluxSIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
