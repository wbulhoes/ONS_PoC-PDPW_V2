<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="frmAssocUsuar.aspx.vb" Inherits="pdpw.frmAssocUsuar"%>
			...
			<tr>
				...
				<td style="WIDTH: 1064px; HEIGHT: 250px" vAlign="top">
					<div align="center">
							...
							<tr>
								<td style="HEIGHT: 10px" height="10">
									<table style="WIDTH: 940px; HEIGHT: 23px" cellSpacing="0" cellPadding="0" width="940" background="../pdpw/images/back_titulo.gif"
										...
										<tr>
											<td style="HEIGHT: 8px">
												<div align="left"><IMG style="WIDTH: 160px; HEIGHT: 23px" height="23" src="../pdpw/images/tit_AssocUsuar.gif"
														width="160"></div>
											</td>
										</tr>
									</table>
						...
						<BR>
						<form id="frmAssocUsuar" name="frmAssocUsuar" runat="server">
									...
									<TR>
										<TD style="HEIGHT: 168px" vAlign="top" align="left" colSpan="3"><asp:datagrid id="dtgAssociar" runat="server" Width="500px" PageSize="5" AllowPaging="True" AutoGenerateColumns="False"
												...
												<Columns>
													...
													<asp:BoundColumn Visible="False" DataField="codempre" HeaderText="codempre"></asp:BoundColumn>
													<asp:BoundColumn DataField="sigempre" HeaderText="Empresa">
							...
							<DIV style="DISPLAY: inline; LEFT: 80px; WIDTH: 347px; POSITION: absolute; TOP: 120px; HEIGHT: 64px">
								<TABLE style="LEFT: 0px; WIDTH: 448px; POSITION: absolute; TOP: 0px; HEIGHT: 60px" cellSpacing="0"
									...
									<TR height="30">
										<TD style="WIDTH: 69px" align="right"><FONT face="Arial" size="2">Empresa:</FONT></TD>
										<TD>&nbsp;
