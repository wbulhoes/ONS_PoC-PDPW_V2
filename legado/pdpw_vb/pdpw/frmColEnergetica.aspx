<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColEnergetica.aspx.vb" Inherits="pdpw.frmColEnergetica" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColEnergetica.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColEnergetica.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
                ...
                <tr>
                    ...
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="../pdpw/images/tit_RazaoEnergetica.gif" width="160" style="width: 160px; height: 23px"></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <form id="frmColEnergetica" name="frmColEnergetica" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 750px" valign="top">
                                <asp:Table ID="tblEnergetica" runat="server" Width="51px" BorderStyle="Ridge" BorderWidth="1px"
