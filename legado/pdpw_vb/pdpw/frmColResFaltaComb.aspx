<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColResFaltaComb.aspx.vb" Inherits="pdpw.frmColResFaltaComb" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColResFaltaComb.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColResFaltaComb.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
                ...
                <tr>
                    ...
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="images/tit_ResFaltaComb.gif" width="296" style="width: 296px; height: 23px">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                            ...
                            <br>
                            <form id="frmColResFaltaComb" name="frmColResFaltaComb" runat="server">
                                <table style="width: 1078px; height: 124px" height="124" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 750px" valign="top">
                                            <div id="divValor" style="display: inline; z-index: 200; left: 189px; width: 82px; position: absolute; top: 270px; height: 21px"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="display: inline; z-index: 1; left: 20px; width: 131px; position: absolute; top: 280px; height: 45px"
                                                ms_positioning="FlowLayout">
                                                <asp:Table ID="tblResFaltaComb" runat="server" Width="47px" Font-Size="Smaller" Height="26px"
