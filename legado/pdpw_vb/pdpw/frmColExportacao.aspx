<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColExportacao.aspx.vb" Inherits="pdpw.frmColExportacao" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>frmColExportacao</title>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColExportacao.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColExportacao.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        <table style="width: 1100px; height: 266px" height="266" cellspacing="0" cellpadding="0"
            ...
            <tbody>
                <tr>
                    <td style="width: 52px; height: 250px" valign="top" width="52">
                        <br>
                    </td>
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="../pdpw/images/tit_ColExportacao.gif" width="120" style="width: 120px; height: 23px"></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <br>
                            <form id="frmColExportacao" name="frmColExportacao" runat="server">
                                <table style="width: 1078px; height: 124px" height="124" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr height="30">
                                        ...
                                        <td style="width: 881px; height: 24px">
                                            <p>
                        ...
                        <tr>
                            <td style="width: 52px" valign="top" align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                            <td style="width: 750px" valign="top">
                                <asp:Table ID="tblExportacao" runat="server" Width="51px" BorderStyle="Ridge" BorderWidth="1px"
