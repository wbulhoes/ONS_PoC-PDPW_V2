...
Public Class relInflexTotalS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relInflexTotalS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelInflexTotalS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relInflexTotalS = New relInflexTotalS()
        rpt.Site = Me.Site
        Return rpt
    End Function
