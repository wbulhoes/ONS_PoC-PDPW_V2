<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColIR2.aspx.vb" Inherits="pdpw.frmColIR2" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColIR2.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColIR2.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                    ...
                    <br>
                    <form id="frmColIR2" name="frmColIR2" runat="server">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblIR2" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
