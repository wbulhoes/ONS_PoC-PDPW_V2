...
Partial Class frmCnsMaqOperando
...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intmos, d.valmos" & strcampo & " as valor, u.ordem, u.nomusina " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intmos"
            Conn.Open()
