...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intrro, d.valrro" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_rro d, usina u " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intrro"
            Conn.Open()
