<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="frmCnsMaqGerando.aspx.vb" Inherits="pdpw.frmCnsMaqGerando"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
				...
				<tr>
					...
					<td vAlign="top" style="HEIGHT: 247px">
						<div align="center">
										...
										<td style="HEIGHT: 10px" height="10">
											<table cellSpacing="0" cellPadding="0" width="765" background="../pdpw/images/back_titulo.gif"
												...
												<tbody>
													<tr>
														<td style="HEIGHT: 8px">
															<div align="left"><IMG height="23" src="../pdpw/images/tit_ColMaqGerando.gif" width="240" style="WIDTH: 240px; HEIGHT: 23px"></div>
														</td>
													</tr>
												</tbody>
											</table>
							...
							<br>
							<form id="frmCnsMaqGerando" name="frmCnsMaqGerando" runat="server">
								<div id="divtabela" style="LEFT: 80px; WIDTH: 603px; POSITION: absolute; TOP: 120px; HEIGHT: 128px">
									<table class="modulo" style="WIDTH: 602px; HEIGHT: 102px" cellSpacing="0" cellPadding="0"
										border="0">
										<tr vAlign="top">
		...
		<DIV style="DISPLAY: inline; LEFT: 78px; WIDTH: 626px; POSITION: absolute; TOP: 260px; HEIGHT: 43px"
			align="left" ms_positioning="FlowLayout">
			<asp:table id="tblConsulta" runat="server" Font-Size="X-Small" Width="598px" CellSpacing="0"
