Partial Class frmCnsMaqGerando
...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intmeg, d.valmeg" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intmeg"
            Conn.Open()
