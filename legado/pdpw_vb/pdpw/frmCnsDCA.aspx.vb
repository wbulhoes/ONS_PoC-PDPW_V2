...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intdca, d.valdca" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_DCA d, usina u " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intdca"
            Conn.Open(strBase)
