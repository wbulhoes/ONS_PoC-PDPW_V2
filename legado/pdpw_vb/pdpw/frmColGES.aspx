<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColGES.aspx.vb" Inherits="pdpw.frmColGES" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColGES.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColGES.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                            ...
                            <td style="height: 10px" height="10">
                                <table cellspacing="0" cellpadding="0" width="765"
                                    ...
                                    <tr>
                                        <td style="height: 8px">
                                            <div align="left">
                                                <p class="titulo">GE Substituição</p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <br>
                    <form id="frmColGES" name="frmColGES" runat="server">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblGES" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
