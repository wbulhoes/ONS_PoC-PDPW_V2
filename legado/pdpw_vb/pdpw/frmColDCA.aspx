<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColDCA.aspx.vb" Inherits="pdpw.frmColDCA" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColDCA.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColDCA.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            ...
            <td style="width: 1064px; height: 250px" valign="top">
                <div align="center">
                            ...
                            <td style="height: 10px" height="10">
                                <table cellspacing="0" cellpadding="0" width="765"
                                    ...
                                    <tr>
                                        <td style="height: 8px">
                                            <div align="left">
                                                <p class="titulo">Despacho Ciclo Aberto</p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <br>
                    <form id="frmColDCA" name="frmColDCA" runat="server">
                            ...
                            <table style="width: 1026px; height: 51px">
                                <tr>
                                    <td style="width: 750px" valign="top">
                                        <asp:Table ID="tblDCA" runat="server" Width="51px" Font-Size="Smaller" Height="26px" GridLines="Both"
