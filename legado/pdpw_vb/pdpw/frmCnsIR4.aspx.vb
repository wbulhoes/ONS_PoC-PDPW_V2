...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intir4, d.valir4" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_IR4 d, usina u " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intir4"
            Conn.Open(strBase)
