...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intges, d.valges" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              "FROM tb_GES d, usina u " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intges"
            Conn.ConnectionString = ConfigurationManager.AppSettings.Get("pdpSQL").ToString()
            Conn.Open()
