...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strCampo As String)
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intrazelet, d.valrazelet" & strCampo & " AS valor, u.ordem, u.nomusina " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intrazelet"
            Conn.ConnectionString = ConfigurationManager.AppSettings.Get("pdpSQL").ToString()
            Conn.Open()
