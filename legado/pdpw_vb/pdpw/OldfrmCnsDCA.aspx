<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" Codebehind="OldfrmCnsDCA.aspx.vb" Inherits="pdpw.frmCnsDCA"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<table style="WIDTH: 792px; HEIGHT: 249px" height="249" cellSpacing="0" cellPadding="0"
			...
			<tr>
				...
				<td style="HEIGHT: 248px" vAlign="top">
					<div align="center">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td style="HEIGHT: 17px" height="17">
									<table style="WIDTH: 772px; HEIGHT: 25px" cellSpacing="0" cellPadding="0" width="772" border="0" background="../pdpw/images/back_tit_sistema.gif">
										<tr>
							...
							<tr>
								<td style="HEIGHT: 10px" height="10">
									<table style="WIDTH: 771px; HEIGHT: 27px" cellSpacing="0" cellPadding="0" width="771"
										...
										<tr>
											<td style="HEIGHT: 8px">
												<div align="left"><p class="titulo">Despacho Ciclo Aberto</p>
												</div>
											</td>
										</tr>
									</table>
						...
						<BR>
						<form id="frmCnsDCA" name="frmCnsDCA" runat="server">
		...
		<div style="DISPLAY: inline; LEFT: 76px; WIDTH: 635px; POSITION: absolute; TOP: 240px; HEIGHT: 36px"
			align="left" ms_positioning="FlowLayout"><asp:table id="tblConsulta" runat="server" Width="609px" Font-Size="X-Small" CellSpacing="0"></asp:table></div>
</asp:Content>
