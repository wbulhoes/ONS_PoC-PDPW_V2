<%@ Page Language="vb" AutoEventWireup="false" Codebehind="frmColMaqGerando.aspx.vb" Inherits="pdpw.frmColMaqGerando"%>
		...
		<script language="JavaScript">
			function RetiraEnter(teclapres) {
				...
				if( tecla == 13 ){
					...
					vr = escape(document.frmColMaqGerando.txtValor.value);
					//TAB + ENTER
					...
					document.frmColMaqGerando.txtValor.value = vr;
				}
			}
		</script>
	</HEAD>
							...
							<div align="center">
								<table cellSpacing="0" cellPadding="0" width="100%" border="0">
									<tbody>
										...
										<TR>
											<TD height="2">
												<TABLE cellSpacing="0" cellPadding="0" width="1076" background="../pdpw/images/back_tit_sistema.gif"
													border="0" style="WIDTH: 1076px; HEIGHT: 25px">
													<TBODY>
														<TR>
										...
										<TR>
											<TD height="2">
												<TABLE cellSpacing="0" cellPadding="0" width="1076" background="../pdpw/images/back_titulo.gif"
													border="0" style="WIDTH: 1076px; HEIGHT: 23px">
													<TBODY>
														<TR>
															<TD>
																<DIV align="left"><IMG style="WIDTH: 224px; HEIGHT: 23px" height="23" src="../pdpw/images/tit_ColMaqGerando.gif"
																		width="224"></DIV>
															</TD>
														</TR>
													</TBODY>
								...
								<BR>
								<form id="frmColMaqGerando" name="frmColMaqGerando" runat="server">
									<table style="WIDTH: 1078px; HEIGHT: 72px" height="72" cellSpacing="0" cellPadding="0"
										width="1078" border="0">
										<tr height="30">
										...
										<tr>
											<td colSpan="2" style="HEIGHT: 66px"><!--br--> <!--br-->
												<DIV style="DISPLAY: inline; Z-INDEX: 1; LEFT: 20px; WIDTH: 152px; POSITION: absolute; TOP: 230px; HEIGHT: 45px"
													ms_positioning="FlowLayout">
													<asp:table id="tblMaqGerando" runat="server" Width="47px" BorderStyle="Ridge" BorderWidth="1px"
