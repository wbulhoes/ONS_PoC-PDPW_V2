<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmCnsRampa.aspx.vb" Inherits="pdpw.frmCnsRampa" %>
            ...
            <tr>
                ...
                <td valign="top">
                    <div align="center">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="height: 8px">
                                                        <div align="left">
                                                            <img height="23" src="../pdpw/images/tit_Rampa.gif" width="184" style="width: 184px; height: 23px"></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <br>
                        <form id="frmCnsRampa" name="frmCnsRampa" runat="server">
