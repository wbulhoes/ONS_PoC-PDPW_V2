<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColGeracao.aspx.vb" Inherits="pdpw.frmColGeracao" %>
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="../pdpw/images/tit_ColGeracao.gif" width="96" style="width: 96px; height: 23px"></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td style="width: 750px; height: 21px">
                                            <p>
                                                &nbsp;<asp:DropDownList ID="cboEmpresa" runat="server" Width="219px" AutoPostBack="True"></asp:DropDownList>&nbsp;&nbsp;&nbsp;
													<strong>Tipos de Usina:</strong>&nbsp;
													<asp:DropDownList ID="cboTipoUsina" runat="server" Width="144px" AutoPostBack="True">
                                                        <asp:ListItem Value="Todos">Todas</asp:ListItem>
                                                        <asp:ListItem Value="Hidro">Hidr&#225;ulica</asp:ListItem>
                                                        <asp:ListItem Value="Termo">T&#233;rmica</asp:ListItem>
                                                    </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;
                                            </p>
                                        </td>
                                    </tr>
