<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColInflexibilidade.aspx.vb" Inherits="pdpw.frmColInflexibilidade" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColInflexibilidade.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColInflexibilidade.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
                ...
                <tr>
                    ...
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img height="23" src="../pdpw/images/tit_ColInflexibilidade.gif" width="152" style="width: 152px; height: 23px"></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <form id="frmColInflexibilidade" name="frmColInflexibilidade" runat="server">
                                ...
                                <br>
                                <table style="width: 1078px; height: 112px" height="112" cellspacing="0" cellpadding="0"
                                    width="1078" border="0">
                                    <tr height="30">
                                    ...
                                    <tr height="30">
                                        <td style="width: 170px; height: 28px" align="right"><b>Empresa:</b></td>
                                        <td style="width: 750px; height: 28px">
                                            <p>&nbsp;<asp:DropDownList ID="cboEmpresa" runat="server" Width="219px" AutoPostBack="True"></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                        </td>
                                    </tr>
                                    <tr height="30">
                                        <td style="width: 170px; height: 13px" align="right"><b>Usinas:</b></td>
                                        <td style="width: 881px; height: 13px">
                                            <p>
                        ...
                        <tr>
                            ...
                            <td style="width: 750px" valign="top">
                                <asp:Table ID="tblInflexibilidade" runat="server" Width="51px" BorderStyle="Ridge" BorderWidth="1px"
