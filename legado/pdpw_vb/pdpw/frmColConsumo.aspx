<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmColConsumo.aspx.vb" Inherits="pdpw.frmColConsumo" %>
    ...
    <script language="JavaScript">
        function RetiraEnter(teclapres) {
            ...
            if (tecla == 13) {
                ...
                vr = escape(document.frmColConsumo.txtValor.value);
                //TAB + ENTER
                ...
                document.frmColConsumo.txtValor.value = vr;
            }
        }
    </script>
</asp:Content>
                ...
                <tr>
                    ...
                    <td style="width: 1064px; height: 250px" valign="top">
                        <div align="center">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="765" background="../pdpw/images/back_titulo.gif"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div align="left">
                                                                <img style="width: 336px; height: 23px" height="23" src="../pdpw/images/tit_ColConsumo.gif"
                                                                    width="336">
                                                            </div>
                                                        </td>
                                                    </tr>
                            ...
                            <br>
                            <form id="frmColConsumo" name="frmColConsumo" runat="server">
                                <table style="width: 1078px; height: 124px" height="124" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="display: inline; z-index: 1; left: 20px; width: 120px; position: absolute; top: 230px; height: 45px"
                                                ms_positioning="FlowLayout">
                                                <asp:Table ID="tblConsumo" runat="server" Width="47px" BorderStyle="Ridge" BorderWidth="1px"
