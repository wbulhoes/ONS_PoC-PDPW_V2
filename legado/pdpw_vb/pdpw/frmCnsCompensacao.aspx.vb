Partial Class frmCnsCompensacao
...
#End Region
    ...
    Private Sub ConsultaIntervalo(ByVal strcampo As String)
        ...
        Dim strCodUsina, strNomeTabela As String
        ...
        Try
            'data pdp
            Cmd.CommandText = "SELECT d.codusina, d.intclf, d.valclf" & strcampo & " AS valor, u.ordem, u.nomusina " &
                              ...
                              "ORDER BY u.ordem, d.codusina, d.intclf"
            Conn.Open()
