...
Public Class relPDDefluxObs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pdpw.relPDDefluxObs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelPDDefluxObs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relPDDefluxObs = New relPDDefluxObs()
        rpt.Site = Me.Site
        Return rpt
    End Function
