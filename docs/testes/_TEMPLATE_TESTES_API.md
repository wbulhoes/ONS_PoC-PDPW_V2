...
- [ ] GET /{entidade}/{campo}/{valor} - Buscas espec�ficas
- [ ] POST /{entidade} - Criar
...
### Testes de Valida��o
- [ ] Campo obrigat�rio vazio: **400 Bad Request**
- [ ] Valor inv�lido: **400 Bad Request**
- [ ] Duplicidade: **400 Bad Request** (se aplic�vel)
...
- [ ] POST criar (v�lido) ? 201
- [ ] POST criar (inv�lido) ? 400
...
- Esta API � usada por: {ENTIDADES_FILHO}
...
### Seguran�a
- [ ] Autentica��o funcionando (se implementada)
- [ ] Autoriza��o funcionando (se implementada)
