...
- ? 10GB de espa�o livre em disco
- ? Conex�o com internet

---

## ?? INSTALA��O R�PIDA (TODOS OS DEVS)

### 1?? Instalar Winget (se n�o tiver)
...
# Verificar
git --version
# Sa�da esperada: git version 2.43.0 (ou superior)
...
?? **Nota:** Para a PoC, usaremos InMemory Database, ent�o SQL Server � opcional.
...
# Ap�s instala��o, reiniciar o computador
...
### 6?? Extens�es Recomendadas para Visual Studio

- C# Dev Kit
- GitHub Copilot (se dispon�vel)
- REST Client
- Docker Extension
- GitLens
...
### 3?? Instalar Extens�es do VS Code
...
# VS Code (para editar documenta��o)
winget install Microsoft.VisualStudioCode
```
...
```powershell
# Executar todos os comandos abaixo e verificar sa�da
...
# Ou o Vite perguntar� automaticamente para usar outra porta
```
...
# 2. Se n�o estiver, instalar WSL 2
wsl --install
...
### Problema: Git clone falha (autentica��o)
...
# Adicionar chave p�blica em: https://github.com/settings/keys
```
...
1. ? **Sincronizar com o time**
   - Confirmar que todos conclu�ram o setup
   - Resolver problemas em conjunto

2. ? **Estudar o c�digo legado**
...
### D�vidas sobre o Dom�nio
- Consultar: `GLOSSARIO.md`
- Analisar c�digo legado em: `pdpw_act/pdpw/`

---

## ? CHECKLIST FINAL PR�-DESENVOLVIMENTO

### Todos os Devs
- [ ] Git instalado e configurado
- [ ] Reposit�rio clonado
- [ ] Branch criada e pushed
- [ ] Documenta��o lida (README, BRIEFING, AN�LISE T�CNICA)
- [ ] Ambiente testado (build/run funciona)

### Backend Devs
- [ ] .NET 8 SDK instalado
- [ ] Visual Studio/Rider instalado
- [ ] Solu��o compila sem erros
- [ ] Swagger acess�vel

### Frontend Dev
- [ ] Node.js 20 instalado
- [ ] VS Code com extens�es instalado
...
**?? SETUP CONCLU�DO! PRONTO PARA DESENVOLVER!** ??
...
**Data:** 19/12/2024  
**Vers�o:** 1.0  
**Pr�ximo passo:** Daily Standup - 09:00 (20/12)
